...
next = 6;
} else if(("A" <= c && c <= "Z")  || ("a" <= c && c <= "k")  || ("m" <= c && c <= "n")  || ("p" <= c && c <= "z") ){
next = 6;
} else if(("_" === c )){
next = 6;
} else if(("l" === c )){
