...
case 68:
			...
			var method = ST.add_method($$[$0-3], new Type("null", "basic", null, null, 0), $$[$0-1], scope)

			this.$.method = method

			for (var index in $$[$0-1]) {
				var variable = scope.add_variable($$[$0-1][index].name, $$[$0-1][index].type)
...
case 69:
			...
			var scope = ST.scope_start(category = "function", name = $$[$0-3]);
			for (var index in $$[$0-3]) {
				var variable = scope.add_variable($$[$0-3][index].name, $$[$0-3][index].type)
				scope.parameters[variable.name] = variable
				variable.isparam = true
			}
...
case 70: case 71:
			...
			for (var index in $$[$0-2]) {
				var variable = scope.add_variable($$[$0-2][index].name, $$[$0-2][index].type)
				scope.parameters[variable.name] = variable
				variable.isparam = true
			}
...
case 193:
			...
			if (!($$[$0].type.category == "basic" && ($$[$0].type.type == $$[$0-2].type || ($$[$0].type.numeric() && $$[$0-2].numeric())))) {
